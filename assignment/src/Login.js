...
function Login() {
    return (
        ...
        <Link to= '/onboard1' style={{margin:"15% 5%",display:"flex",justifyContent:"center",textDecoration:"none"}}><Button style={{color:"black",backgroundColor:"white",fontWeight:"bold",padding:"3% 7%"}}>Log In</Button></Link>
        </div>
        </Col>
        </div>
    )
